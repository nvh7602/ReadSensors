...
/********************************* getDay **********************************
Input: N/A
Output: This function return a string format as: yyyy-mm-dd ( example: 2016925, 20171025, 20991025,.....)
Remarks: 
********************************************************************************/
String DS3231::getFileName()
{
	getDateTime();
	String day = "";
	day += "20";
...
/********************************* getTime *************************************
Input: N/A
Output: Return a string time with format hh:mm:ss (EX: 8:10:12, 13:40:30, ....)
Remarks: 
********************************************************************************/
...
/********************************* getDateTime *************************************
Input: N/A
Output: Set values for seconds, minutes, day, month, year,...values.
Remarks: 
********************************************************************************/
